...
ERROR_CODES = {
    ...
    "Check": _(
        "Grbl is in g-code check mode. If you send g-code to it, it will only check it without actualy doing any motion. You can exit this by $C command (Or equivalent button in terminal tab)"),
